...
N: Seeing that 3 does not do well, we guess that the pattern would be 
gradually better but get back to bad or similar as dim increase. 
Therefore, this time we try multiple dims, all with 3 layers. 
Also, as to evaluation, we will be using ABX test. 
NOTE: In response to much more workload for evaluation, we will switch to 
batch running, instead of single. 
"""
######################### Libs #########################
import torch
...
import argparse
# import summary
from model_model import AEPPV1, AEPPV2, AEPPV3, AEPPV4, AEPPV5, AEPPV6
...
if __name__ == "__main__": 
    ...
    parser.add_argument('--model','-m',type=str, default = "ae",help="Model type")
