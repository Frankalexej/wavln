...
def plot_silhouette(silarray_1, silarray_2, save_path): 
    ...
    mean_trajectory_group1 = group1_array
    mean_trajectory_group2 = group2_array
    ...
    for run_number in learned_runs:
        ...
        for epoch in range(0, 50):     
            ...
            for z in ["z1", "z2"]: 
                ...
                asp_list[z].append(silhouette_avg)
                ...
                X, Y = hidr_cs, tags_cs
                silhouette_avg = silhouette_score(X, tags_cs)
                stop_list[z].append(silhouette_avg)

        for z in ["z1", "z2"]: 
            asp_sils = asp_list[z]
            stop_sils = stop_list[z]
            plot_silhouette(asp_sils, stop_sils, os.path.join(res_save_dir, f"silhouette-VS-{model_type}-{model_condition}-{strseq_learned_runs}at{z}at{run_number}.png"))
    print("Done.")