...
U is replicating T. But with Mel dimension increased to 128 and now with hearable reconstruction. 
As Ming pointed out, 64 may not record the fined details well enough, so there might be some information loss. 
And therefore the model may not even be learning plosive contrasts because they are quite minor in terms of cues. 
"""
######################### Libs #########################
import torch
