"""
C is training on full-set data and testing on part. 
"""
######################### Libs #########################
import torch
...
from model_dataset import WordDataset as TrainDataset
...
def load_data_phenomenon(dataset, rec_dir, target_path, load="train", select="both", sampled=True):
    if sampled: 
