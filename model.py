...
class Encoder(Module): 
    def __init__(self, a, size_list, in_size, in2_size, hid_size):
        ...
        self.rnn = HM_LSTM(a, in_size, size_list)
...
class Decoder(Module): 
    def __init__(self, size_list, in2_size, hid_size, out_size, num_layers=1):
        ...
        self.lin_1 = LinearPack(in_dim=hid_size, out_dim=size_list[1])
    ...
    def inits(self, batch_size, device): 
        ...
        hidden = (h0, c0)
        dec_in_token = torch.zeros((batch_size, 1, self.hid_size), dtype=torch.float, device=device, requires_grad=False)
    ...
    def forward(self, hid_r, in_mask, init_in, hidden):
        ...
        outputs = mask_it(outputs)
        
        return dec_x, attention_weights
