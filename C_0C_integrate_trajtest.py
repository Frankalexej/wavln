...
if __name__ == "__main__":
    ...
    plot_attention_comparison(every_phi_types, every_attns, every_sepframes1, every_sepframes2, os.path.join(res_save_dir, f"attncomp-at-all-{model_type}-{model_condition}-{strseq_learned_runs}.png"))
