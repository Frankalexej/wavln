...
TH is 5-layer with each LSTM layer having a linear layer to merge the hidden states. 
"""
######################### Libs #########################
...
if __name__ == "__main__": 
    ...
    if args.dataprepare: 
        ...
        with open(os.path.join(model_save_dir, "README.note"), "w") as f: 
            ...
            f.write("20240919: 5-layers, with each LSTM layer followed by one linear layer to combine the dimensions\n")
