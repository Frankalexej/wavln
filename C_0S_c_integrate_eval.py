...
if __name__ == "__main__":
    ...
    plot_attention_trajectory_together_012(every_phi_types, every_attns, every_sepframes0, every_sepframes1, every_sepframes2, os.path.join(res_save_dir, f"attntraj-at-all-{model_type}-{model_condition}-{strseq_learned_runs}.png"))
