"""
G is the simple reconstruction encoder trial run. In this run, 
we will test the workflow of reconstruction encoding by trying 
simpler models like linear decoding and LSTM non-autoregressive
decoding. 
