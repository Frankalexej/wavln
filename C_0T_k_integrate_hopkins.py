...
if __name__ == "__main__": 
    ...
    stat_list_epochs = [] # list for each epoch of lists of sse for each run
    for epoch in range(0, 100): 
        ...
        # 开始对每个epoch的结果进行绘图
        # sse_arr = np.array(stat_list_runs) # (run, k)
    ...
    plot_hopkins(stat_list_epochs, os.path.join(this_save_dir, "hopkins", f"{model_type}-{model_condition}-{strseq_learned_runs}.png"))
