...
if __name__ == "__main__": 
    ...
    mk(this_save_dir)
    mk(os.path.join(res_save_dir, test_name))
    ...
    stop_list_epochs = np.load(os.path.join(res_save_dir, test_name, f"04-save-ptk-{model_type}-{model_condition}-{strseq_learned_runs}-{zlevel}.npy"))
    asp_list_epochs = np.load(os.path.join(res_save_dir, test_name, f"05-save-asp-{model_type}-{model_condition}-{strseq_learned_runs}-{zlevel}.npy"))
