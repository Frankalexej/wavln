...
def get_toplot(hiddens, sepframes1, sepframes2, phi_types, stop_names, offsets=(0, 1), contrast_in="asp", merge=True, hidden_dim=8, lookat="stop", include_map=None, aux_on=None): 
    ...
    return hid_sel, np.array(tag_sel), (badcount, len(hiddens))
...
if __name__ == "__main__":
    ...
    if test_name.split("-")[0] in ["clusterARI"]: 
        ...
        for epoch in range(0, 101): 
            ...
            for run_number in learned_runs:
                ...
                hidr_p, tags_p, (bc, ac) = get_toplot(hiddens=all_zq, 
        ...
        layered_res = {}
        for layer in ["attnout", "dec-lin1", "enc-lin1", 
                      "dec-rnn1-f", "enc-rnn1-f", "enc-rnn1-b", "enc-rnn1-l", 
                      "dec-rnn2-f", "enc-rnn2-f", "enc-rnn2-b", "enc-rnn2-l",
                      "dec-rnn3-f", "enc-rnn3-f", "enc-rnn3-b", "enc-rnn3-l",
                      "dec-rnn4-f", "enc-rnn4-f", "enc-rnn4-b", "enc-rnn4-l",
                      "dec-rnn5-f", "enc-rnn5-f", "enc-rnn5-b", "hidrep"]: # "enc-lin1", 
